  ...
  [14],
  {
    "MO+k": function (t, e, n) {
      t.exports = (function (t) {
            ...
            for (var r in a)
              if (a.hasOwnProperty(r)) {
                ...
                delete a[r].channels,
                  ...
                  Object.defineProperty(a[r], "labels", { value: l });
              }
            function s(t, e) {
              return (
                Math.pow(t[0] - e[0], 2) +
        ...
        function r() {
          for (var t = {}, e = Object.keys(a), n = e.length, i = 0; i < n; i++)
        ...
        function o(t) {
          ...
          for (e[t].distance = 0; n.length; )
            for (
              var i = n.pop(), o = Object.keys(a[i]), l = o.length, s = 0;
              s < l;
              s++
            ) {
              var u = o[s],
        ...
        function s(t, e) {
          for (
            var n = [e[t].parent, t], i = a[e[t].parent][t], r = e[t].parent;
            e[r].parent;

          )
            n.unshift(e[r].parent),
              (i = l(a[e[r].parent][r], i)),
              (r = e[r].parent);
        ...
        var u = function (t) {
            for (
              var e = o(t), n = {}, i = Object.keys(e), a = i.length, r = 0;
              r < a;
              r++
            ) {
              var l = i[r];
        ...
        Object.keys(a).forEach(function (t) {
          (d[t] = {}),
            Object.defineProperty(d[t], "channels", { value: a[t].channels }),
            Object.defineProperty(d[t], "labels", { value: a[t].labels });
          var e = u(t);
          ...
          if (t) {
            ...
            if (s) {
              ...
              for (var d = 0; d < o.length; d++)
                o[d] = parseInt(s[d] + s[d], 16);
              u && (l = Math.round((parseInt(u + u, 16) / 255) * 100) / 100);
            } else if ((s = t.match(n))) {
              for (u = s[2], s = s[1], d = 0; d < o.length; d++)
                o[d] = parseInt(s.slice(2 * d, 2 * d + 2), 16);
              ...
              for (d = 0; d < o.length; d++)
                o[d] = Math.round(2.55 * parseFloat(s[d + 1]));
              l = parseFloat(s[4]);
            } else if ((s = t.match(r))) {
            ...
            ? ((this.valid = !1),
              ...
              void ("string" === typeof t
                ? (e = p.getRgba(t))
                  ...
                  : (e = p.getHwb(t)) && this.setValues("hwb", e)
                : "object" === typeof t &&
        ...
        var B = {
            ...
            valueAtIndexOrDefault: function (t, e, n) {
              return B.valueOrDefault(B.isArray(t) ? t[e] : t, n);
            },
            ...
            arrayEquals: function (t, e) {
              ...
              for (n = 0, i = t.length; n < i; ++n)
                if (
                  ...
                  if (!B.arrayEquals(a, r)) return !1;
                } else if (a !== r) return !1;
              return !0;
            },
            clone: function (t) {
              if (B.isArray(t)) return t.map(B.clone);
              if (B.isObject(t)) {
                for (
            ...
            _mergerIf: function (t, e, n) {
              if (N(t)) {
                var i = e[t],
                  a = n[t];
                B.isObject(i) && B.isObject(a)
                  ? B.mergeIf(i, a)
                  : e.hasOwnProperty(t) || (e[t] = B.clone(a));
              }
            },
            merge: function (t, e, n) {
              ...
              for (i = (n = n || {}).merger || B._merger, a = 0; a < u; ++a)
                if (((e = s[a]), B.isObject(e)))
                  for (l = 0, o = (r = Object.keys(e)).length; l < o; ++l)
                    i(r[l], t, e, n);
              return t;
            },
            mergeIf: function (t, e) {
              return B.merge(t, e, { merger: B._mergerIf });
            },
            extend:
              Object.assign ||
              function (t) {
                return B.merge(t, [].slice.call(arguments, 1), {
          ...
          E = B;
        (B.callCallback = B.callback),
          (B.indexOf = function (t, e, n) {
            return Array.prototype.indexOf.call(t, e, n);
          }),
          (B.getValueOrDefault = B.valueOrDefault),
          (B.getValueAtIndexOrDefault = B.valueAtIndexOrDefault);
        var W = {
            linear: function (t) {
              return t;
            },
        ...
        var H = Math.PI,
                ...
                t.moveTo(e, s),
                  l < u && s < d
                    ...
                    ? (t.moveTo(l, n),
                      ...
                      t.arc(l, s, o, U, H + U))
                    : s < d
                    ? (t.arc(l, s, o, -H, 0), t.arc(l, d, o, 0, H))
                    : t.arc(l, s, o, -H, H),
                  t.closePath(),
                  t.moveTo(e, n);
              } else t.rect(e, n, i, a);
                ...
                switch ((t.beginPath(), e)) {
                  ...
                  case "rectRounded":
                    (u = n - (d = 0.516 * n)),
                      (l = Math.cos(c + Y) * u),
                      (s = Math.sin(c + Y) * u),
                      t.arc(i - l, a - s, d, c - H, c - U),
                      t.arc(i + s, a - l, d, c - U, c),
                      t.arc(i + l, a + s, d, c, c + U),
                      t.arc(i - s, a + l, d, c + U, c + H),
                      t.closePath();
                    break;
                  case "rect":
                    if (!r) {
          ...
          K = X;
        (E.clear = X.clear),
          (E.drawRoundedRectangle = function (t) {
            t.beginPath(), X.roundedRect.apply(X, arguments);
          });
        var Z = {
          _set: function (t, e) {
            return E.merge(this[t] || (this[t] = {}), e);
          },
        };
        Z._set("global", {
            ...
            _parseFont: function (t) {
              var e = $.global,
                ...
                i = {
                  ...
                  lineHeight: E.options.toLineHeight(
                    J(t.lineHeight, e.defaultLineHeight),
                    n
                  ),
                  size: n,
              ...
              for (a = 0, r = t.length; a < r; ++a)
                if (
                  ...
                  (void 0 !== e &&
                    "function" === typeof o &&
                    ((o = o(e)), (l = !1)),
                  void 0 !== n && E.isArray(o) && ((o = o[n]), (l = !1)),
                  void 0 !== o)
                )
                  return i && !l && (i.cacheable = !1), o;
            },
          },
          et = {
        ...
        rt.extend(ht.prototype, {
          ...
          pivot: function () {
            var t = this;
            return (
              t._view || (t._view = rt.extend({}, t._model)), (t._start = {}), t
            );
          },
          transition: function (t) {
            ...
            return n && 1 !== t
              ? (a || (a = e._view = {}),
                ...
                ct(i, a, n, t),
                e)
              : ((e._view = rt.extend({}, n)), (e._start = null), e);
          },
        ...
        var mt = {
            ...
            requestAnimationFrame: function () {
              var t = this;
              null === t.request &&
                (t.request = rt.requestAnimFrame.call(window, function () {
            ...
            advance: function () {
              for (var t, e, n, i, a = this.animations, r = 0; r < a.length; )
                (e = (t = a[r]).chart),
                  ...
                  rt.callback(t.render, [e, t], e),
                  rt.callback(t.onAnimationProgress, [t], e),
                  t.currentStep >= n
                    ? (rt.callback(t.onAnimationComplete, [t], e),
                      (e.animating = !1),
                      a.splice(r, 1))
                    : ++r;
            },
                ...
                Object.defineProperty(t, e, {
                  ...
                  value: function () {
                    var e = Array.prototype.slice.call(arguments),
                      a = i.apply(this, e);
                    return (
                      rt.each(t._chartjs.listeners, function (t) {
        ...
        rt.extend(_t.prototype, {
          ...
          linkScales: function () {
            var t = this,
              ...
              a = t.getDataset(),
              r = n.options.scales;
            (null !== e.xAxisID && e.xAxisID in i && !a.xAxisID) ||
              (e.xAxisID = a.xAxisID || r.xAxes[0].id),
              (null !== e.yAxisID && e.yAxisID in i && !a.yAxisID) ||
                (e.yAxisID = a.yAxisID || r.yAxes[0].id);
          },
          getDataset: function () {
          ...
          buildOrUpdateElements: function () {
            var t = this,
              ...
              n = e.data || (e.data = []);
            t._data !== n &&
              (t._data && yt(t._data, t),
              n && Object.isExtensible(n) && xt(n, t),
              (t._data = n)),
              t.resyncElements();
          },
          _configure: function () {
          ...
          _resolveDataElementOptions: function (t, e) {
            ...
            if (((i = i || {}), rt.isArray(h)))
              for (o = 0, l = h.length; o < l; ++o)
                f[(s = h[o])] = vt([i[s], d[s], c[s]], g, e, p);
            else
              for (o = 0, l = (r = Object.keys(h)).length; o < l; ++o)
                f[(s = r[o])] = vt([i[s], d[h[s]], d[s], c[s]], g, e, p);
        ...
        function Mt(t, e) {
          var n = e.startAngle,
            ...
            l = e.y;
          t.beginPath(),
            t.arc(o, l, e.outerRadius, n - r, i + r),
            e.innerRadius > a
              ? ((r = a / e.innerRadius),
                t.arc(o, l, e.innerRadius - a, i + r, n - r, !0))
              : t.arc(o, l, a, i + Math.PI / 2, n - Math.PI / 2),
            t.closePath(),
            t.clip();
        }
        function St(t, e, n, i) {
          ...
          for (
            i &&
              ((n.endAngle = n.startAngle + wt),
              Mt(t, n),
              (n.endAngle = r),
              n.endAngle === n.startAngle &&
                n.fullCircles &&
                ((n.endAngle += wt), n.fullCircles--)),
              t.beginPath(),
              t.arc(
                n.x,
                n.y,
          ...
          for (
            t.beginPath(),
              t.arc(n.x, n.y, e.outerRadius, n.startAngle, n.startAngle + wt),
              a = 0;
            a < n.fullCircles;
            ++a
          )
        ...
        var Pt = ft.extend({
            ...
            inRange: function (t, e) {
              ...
              if (n) {
                for (
                  var i = rt.getAngleFromPoint(n, { x: t, y: e }),
                    a = i.angle,
                    r = i.distance,
                    o = n.startAngle,
                    l = n.endAngle;
            ...
            draw: function () {
              ...
              e.beginPath(),
                ...
                e.closePath(),
                e.fill(),
                n.borderWidth && Ct(e, n, a),
                e.restore();
            },
          }),
          At = rt.valueOrDefault,
          Dt = $.global.defaultColor;
        $._set("global", {
          elements: {
            line: {
              tension: 0.4,
              ...
              if (l.length) {
                ...
                for (
                  r.save(),
                    ...
                    r.lineWidth = At(a.borderWidth, u.borderWidth),
                    r.strokeStyle = a.borderColor || s.defaultColor,
                    r.beginPath(),
                    (n = l[0]._view).skip || (r.moveTo(n.x, n.y), (d = 0)),
                    t = 1;
                  t < l.length;
                  ++t
                )
                  (n = l[t]._view),
                    (e = -1 === d ? rt.previousItem(l, t) : l[d]),
                    n.skip ||
                      ((d !== t - 1 && !o) || -1 === d
                        ? r.moveTo(n.x, n.y)
                        : rt.canvas.lineTo(r, e._view, n),
                      (d = t));
        ...
        var Rt = ft.extend({
            ...
            draw: function (t) {
              var e = this._view,
                ...
                u = s.defaultColor;
              e.skip ||
                ((void 0 === t || rt.canvas._isPointInArea(e, t)) &&
                  ...
                  rt.canvas.drawPoint(n, i, r, o, l, a)));
            },
          }),
          zt = $.global.defaultColor;
        function Nt(t) {
        ...
        function Qt(t, e, n) {
          ...
          return (
            rt.isNullOrUndef(r)
              ? ((i = s * n.categoryPercentage), (a = n.barPercentage))
              : ((i = r * o), (a = 1)),
            { chunk: i / o, ratio: a, start: l - i / 2 }
          );
        }
        function te(t, e, n) {
          var i,
          ...
          return (
            null === o && (o = r - (null === l ? e.end - e.start : l - r)),
            null === l && (l = r + r - o),
            (i = r - ((r - Math.min(o, l)) / 2) * s),
            {
        ...
        var ee = kt.extend({
            ...
            initialize: function () {
              var t,
                e,
                n = this;
              kt.prototype.initialize.apply(n, arguments),
            ...
            updateElement: function (t, e, n) {
              ...
              (t._xScale = i.getScaleForId(a.xAxisID)),
                ...
                rt.isArray(r.data[e]) && (t._model.borderSkipped = null),
            ...
            _updateElementGeometry: function (t, e, n, i) {
              ...
              (r.horizontal = s),
                (r.base = n ? l : d.base),
                (r.x = s ? (n ? l : d.head) : c.center),
                (r.y = s ? c.center : n ? l : d.head),
            ...
            getRuler: function () {
              ...
              for (t = 0, e = n.getMeta().data.length; t < e; ++t)
                a.push(i.getPixelForValue(null, t, n.index));
              return {
                pixels: a,
                start: i._startPixel,
                end: i._endPixel,
            ...
            _resolveDataElementOptions: function () {
              var t = this,
                e = rt.extend(
                  {},
                  kt.prototype._resolveDataElementOptions.apply(t, arguments)
                ),
                n = t._getIndexScale().options,
                i = t._getValueScale().options;
              return (
                (e.barPercentage = $t(n.barPercentage, e.barPercentage)),
                (e.barThickness = $t(n.barThickness, e.barThickness)),
                (e.categoryPercentage = $t(
                  n.categoryPercentage,
                  e.categoryPercentage
                )),
                (e.maxBarThickness = $t(n.maxBarThickness, e.maxBarThickness)),
                (e.minBarLength = $t(i.minBarLength, e.minBarLength)),
                e
              );
            },
          }),
        ...
        var ae = kt.extend({
            ...
            setHoverStyle: function (t) {
              ...
              (t.$previousStyle = {
                ...
                (e.borderColor = ne(n.hoverBorderColor, i(n.borderColor))),
            ...
            _resolveDataElementOptions: function (t, e) {
              ...
              return (
                n._cachedDataOpts === l && (l = rt.extend({}, l)),
                (l.radius = ie(
                  [
                    r.radius,
                    o.r,
          ...
          update: function (t) {
            ...
            for (
              o.borderWidth = r.getMaxBorderWidth(),
                ...
                n = (l.bottom - l.top - o.borderWidth) / d,
          ...
          getMaxBorderWidth: function (t) {
            ...
            for (e = 0, n = t.length; e < n; ++e)
              (a = t[e]),
                ...
                "inner" !== o.borderAlign &&
                  ((l = o.borderWidth),
                  (d = (s = o.hoverBorderWidth) > (d = l > d ? l : d) ? s : d));
            return d;
          },
          setHoverStyle: function (t) {
            var e = t._model,
            ...
            (t.$previousStyle = {
              ...
              (e.borderColor = re(n.hoverBorderColor, i(n.borderColor))),
              (e.borderWidth = re(n.hoverBorderWidth, n.borderWidth));
          },
        ...
        var ve = kt.extend({
            ...
            _resolveDatasetElementOptions: function (t) {
              var e = this,
                ...
                a = e.chart.options,
                r = a.elements.line,
                o = kt.prototype._resolveDatasetElementOptions.apply(
                  e,
                  arguments
                );
              return (
                (o.spanGaps = ce(n.spanGaps, a.spanGaps)),
                (o.tension = ce(n.lineTension, r.tension)),
                (o.steppedLine = he([i.steppedLine, n.steppedLine, r.stepped])),
                (o.clip = me(
                  ce(n.clip, pe(e._xScale, e._yScale, o.borderWidth))
                )),
                o
              );
            },
                  ...
                  (a = c.data.datasets[r.index]),
                    "line" === r.type &&
                      ...
                      ((o = +h.getRightValue(a.data[e])) < 0
                        ...
                        : (f += o || 0));
                return l < 0
                  ? h.getPixelForValue(g + l)
                  : h.getPixelForValue(f + l);
              }
            ...
            updateBezierControlPoints: function () {
              ...
              if (
                ...
                rt.splineCurveMonotone(u);
              else
                for (t = 0, e = u.length; t < e; ++t)
                  (n = u[t]._model),
                    (i = rt.splineCurve(
                      rt.previousItem(u, t)._model,
                      n,
                      rt.nextItem(u, t)._model,
                      l.tension
                    )),
            ...
            setHoverStyle: function (t) {
              ...
              (t.$previousStyle = {
                ...
                (e.backgroundColor = ce(
                  n.hoverBackgroundColor,
                  i(n.backgroundColor)
                )),
                (e.borderColor = ce(n.hoverBorderColor, i(n.borderColor))),
        ...
        var xe = kt.extend({
          ...
          update: function (t) {
            ...
            for (
              ...
              (s[e] = l), (i = a._computeAngle(e)), (u[e] = i), (l += i);
          ...
          updateElement: function (t, e, n) {
            var i = this,
              ...
              m = l.animateScale
                ? 0
                : s.getDistanceFromCenterForValue(r.data[e]),
              v = t._options || {};
            rt.extend(t, {
              _datasetIndex: i.index,
              _index: e,
        ...
        $._set("pie", rt.clone($.doughnut)),
          $._set("pie", { cutoutPercentage: 0 });
        var ye = ue,
        ...
        var ke = kt.extend({
          ...
          _resolveDatasetElementOptions: function () {
            var t = this,
              e = t._config,
              n = t.chart.options,
              i = kt.prototype._resolveDatasetElementOptions.apply(
                t,
                arguments
              );
            return (
              (i.spanGaps = _e(e.spanGaps, n.spanGaps)),
              (i.tension = _e(e.lineTension, n.elements.line.tension)),
              i
            );
          },
          updateBezierControlPoints: function () {
            ...
            for (
              ...
              (n = l[t]._model),
                (i = rt.splineCurve(
                  rt.previousItem(l, t, !0)._model,
                  n,
                  rt.nextItem(l, t, !0)._model,
                  n.tension
                )),
          ...
          setHoverStyle: function (t) {
            ...
            (t.$previousStyle = {
              ...
              (e.backgroundColor = _e(
                n.hoverBackgroundColor,
                i(n.backgroundColor)
              )),
              (e.borderColor = _e(n.hoverBorderColor, i(n.borderColor))),
              (e.borderWidth = _e(n.hoverBorderWidth, n.borderWidth)),
              (e.radius = _e(n.hoverRadius, n.radius));
          },
        });
        $._set("scatter", {
          hover: { mode: "single" },
          ...
          $._set("global", { datasets: { scatter: { showLine: !1 } } });
        var we = {
          bar: ee,
          bubble: ae,
          doughnut: ue,
        ...
        function Me(t, e) {
          return t.native ? { x: t.x, y: t.y } : rt.getRelativePosition(t, e);
        }
        function Se(t, e) {
          var n,
            i,
          ...
          for (i = 0, r = s.length; i < r; ++i)
            for (a = 0, o = (n = s[i].data).length; a < o; ++a)
        ...
        var je = {
            ...
            update: function (t, e, n) {
              if (t) {
                var i = t.options.layout || {},
                  ...
                  c = Ie(
                    { maxPadding: Ie({}, a), w: r, h: o, x: a.left, y: a.top },
                    a
                  );
                Re(s.concat(u), d),
                  Ve(s, c, d),
          ...
          Ye = n(Object.freeze({ __proto__: null, default: Ue })),
          Ge = "$chartjs",
          Xe = "chartjs-",
          Ke = Xe + "size-monitor",
        ...
        function sn(t, e) {
          ...
          return function () {
            (i = Array.prototype.slice.call(arguments)),
              ...
              n ||
                ((n = !0),
                rt.requestAnimFrame.call(window, function () {
                  (n = !1), t.apply(e, i);
                }));
          };
        }
        ...
        function dn(t) {
          ...
          return (
            an(i, "scroll", r.bind(i, "expand")),
            an(a, "scroll", r.bind(a, "shrink")),
            n
          );
        }
        function cn(t, e) {
        ...
        (rt.addEvent = an), (rt.removeEvent = rn);
        var vn = mn._enabled ? mn : qe,
          bn = rt.extend(
            {
              initialize: function () {},
        ...
        var xn = {
            ...
            notify: function (t, e, n) {
              ...
              for (i = 0; i < u; ++i)
                if (
                  "function" === typeof (l = (r = (a = s[i]).plugin)[e]) &&
                ...
                this._plugins.concat(a.plugins || []).forEach(function (t) {
                  if (-1 === n.indexOf(t)) {
                    var e = t.id,
                      a = r[e];
                    !1 !== a &&
                      (!0 === a && (a = rt.clone($.global.plugins[e])),
                      n.push(t),
          ...
          yn = {
            ...
            getScaleDefaults: function (t) {
              return this.defaults.hasOwnProperty(t)
                ? rt.merge(Object.create(null), [$.scale, this.defaults[t]])
                : {};
            },
            updateScaleDefaults: function (t, e) {
              var n = this;
              n.defaults.hasOwnProperty(t) &&
                (n.defaults[t] = rt.extend(n.defaults[t], e));
            },
          ...
          _n = rt.valueOrDefault,
          kn = rt.rtl.getRtlAdapter;
        $._set("global", {
          tooltips: {
            enabled: !0,
            custom: null,
            ...
            callbacks: {
              ...
              label: function (t, e) {
                ...
                return (
                  n && (n += ": "),
                  rt.isNullOrUndef(t.value) ? (n += t.yLabel) : (n += t.value),
                  n
                );
              },
        ...
        function Mn(t, e) {
          return (
            e && (rt.isArray(e) ? Array.prototype.push.apply(t, e) : t.push(e)),
            t
          );
        }
        function Sn(t) {
        ...
        function Pn(t) {
          ...
          return {
            ...
            _bodyFontFamily: _n(t.bodyFontFamily, e.defaultFontFamily),
            _bodyFontStyle: _n(t.bodyFontStyle, e.defaultFontStyle),
            _bodyAlign: t.bodyAlign,
            bodyFontSize: _n(t.bodyFontSize, e.defaultFontSize),
            bodySpacing: t.bodySpacing,
            titleFontColor: t.titleFontColor,
            _titleFontFamily: _n(t.titleFontFamily, e.defaultFontFamily),
            _titleFontStyle: _n(t.titleFontStyle, e.defaultFontStyle),
            titleFontSize: _n(t.titleFontSize, e.defaultFontSize),
            _titleAlign: t.titleAlign,
            titleSpacing: t.titleSpacing,
            titleMarginBottom: t.titleMarginBottom,
            footerFontColor: t.footerFontColor,
            _footerFontFamily: _n(t.footerFontFamily, e.defaultFontFamily),
            _footerFontStyle: _n(t.footerFontStyle, e.defaultFontStyle),
            footerFontSize: _n(t.footerFontSize, e.defaultFontSize),
        ...
        function An(t, e) {
          ...
          (i += l * u),
            ...
            (i += s ? e.footerMarginTop : 0),
            (i += s * c),
            (i += s ? (s - 1) * e.footerSpacing : 0);
          var h = 0,
            f = function (t) {
              a = Math.max(a, n.measureText(t).width + h);
            };
          return (
            (n.font = rt.fontString(u, e._titleFontStyle, e._titleFontFamily)),
            rt.each(e.title, f),
            (n.font = rt.fontString(d, e._bodyFontStyle, e._bodyFontFamily)),
            rt.each(e.beforeBody.concat(e.afterBody), f),
            (h = e.displayColors ? d + 2 : 0),
            rt.each(r, function (t) {
              rt.each(t.before, f), rt.each(t.lines, f), rt.each(t.after, f);
            }),
            (h = 0),
            (n.font = rt.fontString(
              c,
              e._footerFontStyle,
              e._footerFontFamily
            )),
        ...
        function Dn(t, e) {
          ...
          l.y < e.height
            ? (c = "top")
            : l.y > s.height - e.height && (c = "bottom");
          ...
          "center" === c
            ...
            n(l.x)
              ? ((d = "left"), a(l.x) && ((d = "center"), (c = o(l.y))))
              : i(l.x) &&
                ((d = "right"), r(l.x) && ((d = "center"), (c = o(l.y))));
          var g = t._options;
          return {
        ...
        var On = ft.extend({
            initialize: function () {
              (this._model = Pn(this._options)), (this._lastActive = []);
            },
            getTitle: function () {
              var t = this,
                ...
                r = [];
              return (r = Mn(r, Sn(n))), (r = Mn(r, Sn(i))), (r = Mn(r, Sn(a)));
            },
            ...
            getBody: function (t, e) {
              ...
              return (
                rt.each(t, function (t) {
                  ...
                  Mn(r.before, Sn(i.beforeLabel.call(n, t, e))),
                    Mn(r.lines, i.label.call(n, t, e)),
                    Mn(r.after, Sn(i.afterLabel.call(n, t, e))),
                    a.push(r);
                }),
                a
              );
            ...
            update: function (t) {
              var e,
                ...
                h = { x: r.caretX, y: r.caretY };
              if (l.length) {
                o.opacity = 1;
                var f = [],
                  g = [];
                h = wn[a.position].call(i, l, i._eventPosition);
                var p = [];
                for (e = 0, n = l.length; e < n; ++e) p.push(Cn(l[e]));
                a.filter &&
                  ...
                  rt.each(p, function (t) {
                    f.push(a.callbacks.labelColor.call(i, t, i._chart)),
                      g.push(a.callbacks.labelTextColor.call(i, t, i._chart));
                  }),
                  (o.title = i.getTitle(p, s)),
                  (o.beforeBody = i.getBeforeBody(p, s)),
                  (o.body = i.getBody(p, s)),
                  (o.afterBody = i.getAfterBody(p, s)),
                  (o.footer = i.getFooter(p, s)),
                  (o.x = h.x),
                  (o.y = h.y),
                  ...
                  (o.labelTextColors = g),
                  (o.dataPoints = p),
                  (d = Tn(o, (c = An(this, o)), (u = Dn(this, c)), i._chart));
              } else o.opacity = 0;
              return (
                (o.xAlign = u.xAlign),
                (o.yAlign = u.yAlign),
            ...
            drawTitle: function (t, e, n) {
              var i,
                ...
                l = o.length;
              if (l) {
                var s = kn(e.rtl, e.x, e.width);
                for (
                  t.x = In(e, e._titleAlign),
                  ...
                  n.fillText(o[r], s.x(t.x), t.y + i / 2),
                    (t.y += i + a),
                    r + 1 === l && (t.y += e.titleMarginBottom - a);
              }
            },
                ...
                for (
                  ...
                  if (p) {
                    ...
                    (n.fillStyle = e.legendColorBackground),
                      n.fillRect(b.leftForLtr(_, c), t.y, c, c),
                      (n.lineWidth = 1),
                      (n.strokeStyle = r.borderColor),
                      n.strokeRect(b.leftForLtr(_, c), t.y, c, c),
                      (n.fillStyle = r.backgroundColor),
                      n.fillRect(
                        b.leftForLtr(b.xPlus(_, 1), c - 2),
                        t.y + 1,
                        c - 2,
                        c - 2
                      ),
            ...
            drawFooter: function (t, e, n) {
              var i,
                ...
                o = r.length;
              if (o) {
                var l = kn(e.rtl, e.x, e.width);
                for (
                  t.x = In(e, e._footerAlign),
                  ...
                  n.fillText(r[a], l.x(t.x), t.y + i / 2),
            ...
            drawBackground: function (t, e, n, i) {
              ...
              n.beginPath(),
                ...
                n.lineTo(o + s - d, l),
                n.quadraticCurveTo(o + s, l, o + s, l + d),
                "center" === r && "right" === a && this.drawCaret(t, i),
                n.lineTo(o + s, l + u - d),
                n.quadraticCurveTo(o + s, l + u, o + s - d, l + u),
                "bottom" === r && this.drawCaret(t, i),
                n.lineTo(o + d, l + u),
                n.quadraticCurveTo(o, l + u, o, l + u - d),
                "center" === r && "left" === a && this.drawCaret(t, i),
                n.lineTo(o, l + d),
                n.quadraticCurveTo(o, l, o + d, l),
                n.closePath(),
                n.fill(),
            ...
            draw: function () {
              ...
              if (0 !== e.opacity) {
                ...
                this._options.enabled &&
                  ...
                  (i.y += e.yPadding),
                  rt.rtl.overrideTextDirection(t, e.textDirection),
                  this.drawTitle(i, e, t),
                  this.drawBody(i, e, t),
                  this.drawFooter(i, e, t),
                  rt.rtl.restoreTextDirection(t, e.textDirection),
                  t.restore());
              }
            },
            handleEvent: function (t) {
              ...
              return (
                ...
                (i = !rt.arrayEquals(e._active, e._lastActive)) &&
          ...
          Rn = On;
        Rn.positioners = Ln;
        var zn = rt.valueOrDefault;
        function Nn() {
          return rt.merge(Object.create(null), [].slice.call(arguments), {
                ...
                for (e[t] || (e[t] = []), a = 0; a < l; ++a)
                  (o = n[t][a]),
                    ...
                    !e[t][a].type || (o.type && o.type !== e[t][a].type)
                      ? rt.merge(e[t][a], [yn.getScaleDefaults(r), o])
                      : rt.merge(e[t][a], o);
          ...
          return rt.merge(Object.create(null), [].slice.call(arguments), {
            merger: function (t, e, n, i) {
              ...
              "scales" === t
                ? (e[t] = Nn(a, r))
                : "scale" === t
                ? (e[t] = rt.merge(a, [yn.getScaleDefaults(r.type), r]))
                : rt._merger(t, e, n, i);
            },
          });
        }
        function En(t) {
          ...
          return (
            ...
            (e.labels = e.labels || []),
            (t.options = Bn($.global, $[t.type], t.options || {})),
            t
          );
        }
        function Wn(t) {
        ...
        rt.extend(qn.prototype, {
          construct: function (t, e) {
            var n = this;
            e = En(e);
            var i = bn.acquireContext(t, e),
              a = i && i.canvas,
              r = a && a.height,
              o = a && a.width;
            (n.id = rt.uid()),
          ...
          initialize: function () {
            var t = this;
            return (
              xn.notify(t, "beforeInit"),
              rt.retinaScale(t, t.options.devicePixelRatio),
              t.bindEvents(),
              t.options.responsive && t.resize(!0),
              t.initToolTip(),
              xn.notify(t, "afterInit"),
              t
            );
          },
          clear: function () {
          ...
          resize: function (t) {
            ...
            if (
              ...
              (i.style.width = r + "px"),
              (i.style.height = o + "px"),
              rt.retinaScale(e, n.devicePixelRatio),
              !t)
            ) {
              var l = { width: r, height: o };
              xn.notify(e, "resize", [l]),
            ...
            e.scales &&
              ...
              rt.each(i, function (e) {
                var i = e.options,
                  r = i.id,
                  o = zn(i.type, e.dtype);
                Hn(i.position) !== Hn(e.dposition) &&
                  (i.position = e.dposition),
                  (a[r] = !0);
                var l = null;
                if (r in n && n[r].type === o)
                  ((l = n[r]).options = i), (l.ctx = t.ctx), (l.chart = t);
                else {
                  var s = yn.getScaleConstructor(o);
                  if (!s) return;
                  (l = new s({
                    id: r,
                    type: o,
            ...
            if (
              ...
              i.updateLayout(),
                i.options.animation &&
                  ...
                  rt.each(a, function (t) {
                    t.reset();
                  }),
                i.updateDatasets(),
                i.tooltip.initialize(),
                (i.lastActive = []),
                xn.notify(i, "afterUpdate"),
                i._layers.sort(jn("z", "_idx")),
                i._bufferedRender
                  ? (i._bufferedRequest = {
                      duration: t.duration,
                      easing: t.easing,
          ...
          updateLayout: function () {
            var t = this;
            !1 !== xn.notify(t, "beforeLayout") &&
              (je.update(this, this.width, this.height),
              (t._layers = []),
              rt.each(
                t.boxes,
                function (e) {
              ...
              xn.notify(t, "afterScaleUpdate"),
              xn.notify(t, "afterLayout"));
          },
          ...
          updateDataset: function (t) {
            var e = this,
              ...
              i = { meta: n, index: t };
            !1 !== xn.notify(e, "beforeDatasetUpdate", [i]) &&
              (n.controller._update(), xn.notify(e, "afterDatasetUpdate", [i]));
          },
          render: function (t) {
            var e = this;
            (t && "object" === typeof t) ||
            ...
            if (!1 !== xn.notify(e, "beforeRender")) {
              var r = function (t) {
                xn.notify(e, "afterRender"),
                  rt.callback(n && n.onComplete, [t], e);
              };
              if (n && i) {
                var o = new pt({
                  numSteps: i / 16.66,
          ...
          _getSortedDatasetMetas: function (t) {
            var e,
              ...
              a = [];
            for (e = 0, n = (i.data.datasets || []).length; e < n; ++e)
              (t && !i.isDatasetVisible(e)) || a.push(i.getDatasetMeta(e));
            return a.sort(jn("order", "index")), a;
          },
          ...
          drawDatasets: function (t) {
            var e,
              n,
              i = this;
            if (!1 !== xn.notify(i, "beforeDatasetsDraw", [t])) {
              for (
                n = (e = i._getSortedVisibleDatasetMetas()).length - 1;
                n >= 0;
                --n
              )
                i.drawDataset(e[n], t);
              xn.notify(i, "afterDatasetsDraw", [t]);
            }
          },
          drawDataset: function (t, e) {
            var n = this,
              i = { meta: t, index: t.index, easingValue: e };
            !1 !== xn.notify(n, "beforeDatasetDraw", [i]) &&
              (t.controller.draw(e), xn.notify(n, "afterDatasetDraw", [i]));
          },
          _drawTooltip: function (t) {
            var e = this,
              n = e.tooltip,
              i = { tooltip: n, easingValue: t };
            !1 !== xn.notify(e, "beforeTooltipDraw", [i]) &&
              (n.draw(), xn.notify(e, "afterTooltipDraw", [i]));
          },
          getElementAtEvent: function (t) {
            return Te.modes.single(this, t);
          },
          getElementsAtEvent: function (t) {
            return Te.modes.label(this, t, { intersect: !0 });
          },
          getElementsAtXAxis: function (t) {
            return Te.modes["x-axis"](this, t, { intersect: !0 });
          },
          ...
          getDatasetAtEvent: function (t) {
            return Te.modes.dataset(this, t, { intersect: !0 });
          },
          ...
          bindEvents: function () {
            ...
            rt.each(t.options.events, function (i) {
              bn.addEventListener(t, i, n), (e[i] = n);
            }),
              t.options.responsive &&
                ((n = function () {
                  t.resize();
                }),
                bn.addEventListener(t, "resize", n),
                (e.resize = n));
          },
          ...
          handleEvent: function (t) {
            ...
            return (
              ...
              (a = !rt.arrayEquals(e.active, e.lastActive)),
        ...
        var Yn = function () {
          ...
          function n(n, i, a) {
            ...
            return u || d
              ? Math.min(u ? t(l, n, a) : c, d ? t(s, o, a) : c)
              : "none";
          }
          (rt.where = function (t, e) {
            ...
            (rt.findIndex = Array.prototype.findIndex
              ? function (t, e, n) {
            ...
            (rt.EPSILON = Number.EPSILON || 1e-14),
            (rt.splineCurveMonotone = function (t) {
              var e,
                n,
                i,
                a,
              ...
              for (e = 0; e < c - 1; ++e)
                (i = d[e]),
                  ...
                  i.model.skip ||
                    a.model.skip ||
                    (rt.almostEquals(i.deltaK, 0, this.EPSILON)
                      ? (i.mK = a.mK = 0)
                      : ((r = i.mK / i.deltaK),
                        (o = a.mK / i.deltaK),
                        (s = Math.pow(r, 2) + Math.pow(o, 2)) <= 9 ||
                          ((l = 3 / Math.sqrt(s)),
                          (i.mK = r * l * i.deltaK),
                          (a.mK = o * l * i.deltaK))));
              for (e = 0; e < c; ++e)
            ...
            (rt.getRelativePosition = function (t, e) {
              ...
              return {
                x: (n = Math.round(
                  (((n - o.left - s) / h) * r.width) / e.currentDevicePixelRatio
                )),
                y: (i = Math.round(
            ...
            (rt._calculatePadding = function (t, e, n) {
              return (e = rt.getStyle(t, e)).indexOf("%") > -1
                ? (n * parseInt(e, 10)) / 100
                : parseInt(e, 10);
            }),
            ...
            (rt.getMaximumWidth = function (t) {
              ...
              var n = e.clientWidth,
                i =
                  n -
                  rt._calculatePadding(e, "padding-left", n) -
                  rt._calculatePadding(e, "padding-right", n),
            ...
            (rt.getMaximumHeight = function (t) {
              ...
              var n = e.clientHeight,
                i =
                  n -
                  rt._calculatePadding(e, "padding-top", n) -
                  rt._calculatePadding(e, "padding-bottom", n),
            ...
            (rt.longestText = function (t, e, n, i) {
              ...
              var o,
                ...
                h = n.length;
              for (o = 0; o < h; o++)
                if (void 0 !== (u = n[o]) && null !== u && !0 !== rt.isArray(u))
                  c = rt.measureText(t, a, r, c, u);
                else if (rt.isArray(u))
                  for (l = 0, s = u.length; l < s; l++)
                    void 0 === (d = u[l]) ||
                      null === d ||
                      rt.isArray(d) ||
                      (c = rt.measureText(t, a, r, c, d));
              var f = r.length / 2;
              if (f > n.length) {
            ...
            (rt.color = z
              ? function (t) {
                  return (
                    t instanceof CanvasGradient && (t = $.global.defaultColor),
                    z(t)
                  );
                }
              : function (t) {
            ...
            (rt.getHoverColor = function (t) {
              return t instanceof CanvasPattern || t instanceof CanvasGradient
                ? t
                : rt.color(t).saturate(0.5).darken(0.1).rgbString();
            });
        };
        function Gn() {
          throw new Error(
        ...
        var Kn = { _date: Xn },
          ...
          $n = rt.isArray,
          Jn = rt.isNullOrUndef,
          Qn = rt.valueOrDefault,
          ti = rt.valueAtIndexOrDefault;
        function ei(t, e) {
              ...
              if ($n(l))
                for (r = 0, o = l.length; r < o; ++r)
                  (g = l[r]),
                    Jn(g) ||
                      $n(g) ||
                      ((h = rt.measureText(t, d.data, d.gc, h, g)), (f += c));
        ...
        function oi(t) {
          var e, n;
          return t.display
            ? ((e = rt.options._parseFont(t)),
              (n = rt.options.toPadding(t.padding)),
              e.lineHeight + n.height)
            : 0;
        }
        function li(t, e) {
          return rt.extend(
            rt.options._parseFont({
        ...
        function si(t) {
          var e = li(t, t.minor);
          return { minor: e, major: t.major.enabled ? li(t, t.major) : e };
        }
        function ui(t) {
          var e,
            n,
            ...
            a = [];
          for (n = 0, i = t.length; n < i; ++n)
            "undefined" !== typeof (e = t[n])._index && a.push(e);
          return a;
        }
        function di(t) {
          var e,
        ...
        function gi(t, e, n, i) {
          var a,
            ...
            l,
            s = Qn(n, 0),
            u = Math.min(Qn(i, t.length), t.length),
            d = 0;
          for (
            e = Math.ceil(e), i && (e = (a = i - n) / Math.floor(a / e)), l = s;
            l < 0;

          )
            d++, (l = Math.round(s + d * e));
          for (r = Math.max(s, 0); r < u; r++)
            (o = t[r]),
              r === l
                ? ((o._index = r), d++, (l = Math.round(s + d * e)))
                : delete o.label;
        }
        $._set("scale", {
          display: !0,
        ...
        var pi = ft.extend({
          ...
          update: function (t, e, n) {
            ...
            if (
              ...
              for (o = [], i = 0, a = s.ticks.length; i < a; ++i)
                o.push({ value: s.ticks[i], major: !1 });
            return (
              (s._ticks = o),
              (l = d < o.length),
              (r = s._convertTicksToLabels(l ? ei(o, d) : o)),
              s._configure(),
              ...
              (s._ticksToDraw =
                u.display && (u.autoSkip || "auto" === u.source)
                  ? s._autoSkip(o)
                  : o),
              l && (r = s._convertTicksToLabels(s._ticksToDraw)),
              (s.ticks = r),
              s.afterUpdate(),
              s.minSize
            );
          ...
          afterBuildTicks: function (t) {
            var e = this;
            return $n(t) && t.length
              ? rt.callback(e.options.afterBuildTicks, [e, t])
              : ((e.ticks =
                  rt.callback(e.options.afterBuildTicks, [e, e.ticks]) ||
                  e.ticks),
                t);
          },
          ...
          calculateTickRotation: function () {
            ...
            !l.isHorizontal()
              ...
              : ((e = (t = l._getLabelSizes()).widest.width),
                ...
                (i = Math.min(l.maxWidth, l.chart.width - e)),
                e + 6 > (a = s.offset ? l.maxWidth / d : i / (d - 1)) &&
                  ((a = i / (d - (s.offset ? 0.5 : 1))),
                  (r =
                    l.maxHeight -
                    ri(s.gridLines) -
                    u.padding -
          ...
          fit: function () {
            var t = this,
              ...
              u = t.isHorizontal();
            if (
              (u ? (e.width = t.maxWidth) : l && (e.width = ri(o) + oi(r)),
              u ? l && (e.height = ri(o) + oi(r)) : (e.height = t.maxHeight),
              a.display && l)
            ) {
              var d = si(a),
                c = t._getLabelSizes(),
          ...
          _autoSkip: function (t) {
            var e,
              ...
              u = o.major.enabled ? hi(t) : [],
              d = u.length,
              c = u[0],
              h = u[d - 1];
            if (d > s) return fi(t, u, d / s), ui(t);
            if (((i = ci(u, t, l, s)), d > 0)) {
              for (e = 0, n = d - 1; e < n; e++) gi(t, i, u[e], u[e + 1]);
              return (
                (a = d > 1 ? (h - c) / (d - 1) : null),
                gi(t, i, rt.isNullOrUndef(a) ? 0 : c - a, c),
                gi(t, i, h, rt.isNullOrUndef(a) ? t.length : h + a),
                ui(t)
              );
            }
            return gi(t, i), ui(t);
          ...
          _isVisible: function () {
            ...
            for (t = 0, e = a.data.datasets.length; t < e; ++t)
              if (
                ...
                ((n = a.getDatasetMeta(t)).xAxisID === i.id ||
                  n.yAxisID === i.id)
              )
                return !0;
            return !1;
          ...
          _computeGridLineItems: function (t) {
            ...
            for (
              ...
              (i = S[n] || {}),
                (Jn(i.label) && n < S.length) ||
                  (n === b.zeroLineIndex && y.offset === w
                    ? ((g = _.zeroLineWidth),
                      (p = _.zeroLineColor),
                      (m = _.zeroLineBorderDash || []),
                      (v = _.zeroLineBorderDashOffset || 0))
                    : ((g = ti(_.lineWidth, n, 1)),
                      (p = ti(_.color, n, "rgba(0,0,0,0.1)")),
                      (m = _.borderDash || []),
                      (v = _.borderDashOffset || 0)),
                  void 0 !== (a = ni(b, i._index || n, w)) &&
                    ((r = I(x, a, g)),
                    M ? (o = s = d = h = r) : (l = u = c = f = r),
                    A.push({
                      tx1: o,
                      ty1: l,
                      tx2: s,
          ...
          _computeLabelItems: function () {
            ...
            for (
              "top" === p
                ? ((r = h.bottom - _ - y), (o = k ? "left" : "center"))
                : "bottom" === p
                ? ((r = h.top + _ + y), (o = k ? "right" : "center"))
                : "left" === p
          ...
          _drawGrid: function (t) {
            ...
            if (n.display) {
              var i,
                ...
                u = e.chart,
                d = rt._alignPixel,
                c = n.drawBorder ? ti(n.lineWidth, 0, 0) : 0,
                h =
                  e._gridLineItems ||
              ...
              if (c) {
                var f,
                  ...
                  m,
                  v = c,
                  b = ti(n.lineWidth, h.ticksLength - 1, 1),
                  x = h.borderValue;
                e.isHorizontal()
                  ? ((f = d(u, e.left, v) - v / 2),
                    (g = d(u, e.right, b) + b / 2),
          ...
          _drawTitle: function () {
            ...
            if (i.display) {
              var a,
                r,
                o = Qn(i.fontColor, $.global.defaultFontColor),
        ...
        pi.prototype._draw = pi.prototype.draw;
        var mi = pi,
          vi = rt.isNullOrUndef,
          bi = { position: "bottom" },
          xi = mi.extend({
            ...
            _configure: function () {
              var t = this,
                e = t.options.offset,
                n = t.ticks;
              mi.prototype._configure.call(t),
            ...
            getPixelForValue: function (t, e, n) {
              var i,
                ...
                o = this;
              return (
                vi(e) || vi(n) || (t = o.chart.data.datasets[n].data[e]),
                vi(t) || (i = o.isHorizontal() ? t.x : t.y),
                (void 0 !== i || (void 0 !== t && isNaN(e))) &&
                  ((a = o._getLabels()),
                  (t = rt.valueOrDefault(i, t)),
        ...
        function wi(t, e) {
          ...
          if (m < l && ki(c) && ki(h)) return [g, p];
          (r = Math.ceil(p / m) - Math.floor(g / m)) > d &&
            (m = rt.niceNum((r * m) / d / u) * u),
            s || ki(f)
              ? (n = Math.pow(10, rt._decimalPlaces(m)))
              : ((n = Math.pow(10, f)), (m = Math.ceil(m * n) / n)),
            (i = Math.floor(g / m) * m),
            (a = Math.ceil(p / m) * m),
            s &&
              (!ki(c) && rt.almostWhole(c / m, m / 1e3) && (i = c),
              !ki(h) && rt.almostWhole(h / m, m / 1e3) && (a = h)),
            (r = (a - i) / m),
            (r = rt.almostEquals(r, Math.round(r), m / 1e3)
              ? Math.round(r)
              : Math.ceil(r)),
            (i = Math.round(i * n) / n),
            (a = Math.round(a * n) / n),
          ...
          return o.push(ki(h) ? a : h), o;
        }
        var Mi = mi.extend({
            getRightValue: function (t) {
              return "string" === typeof t
                ? +t
                : mi.prototype.getRightValue.call(this, t);
            },
            ...
            convertTicksToLabels: function () {
              ...
              (t.ticksAsNumbers = t.ticks.slice()),
                ...
                mi.prototype.convertTicksToLabels.call(t);
            },
            _configure: function () {
              var t,
                e = this,
                ...
                i = e.min,
                a = e.max;
              mi.prototype._configure.call(e),
                e.options.offset &&
                  n.length &&
          ...
          Si = { position: "left", ticks: { callback: Zn.formatters.linear } },
          Ci = 0,
          Pi = 1;
        function Ai(t, e, n) {
          var i = [
        ...
        var Ii = Mi.extend({
            determineDataLimits: function () {
              ...
              for (t = 0; t < d; ++t)
                (n = o[(e = l[t]).index].data),
                  s ? Di(a, u, e, n) : Ti(a, e, n);
              rt.each(u, function (t) {
                (i = t.pos.concat(t.neg)),
                  (a.min = Math.min(a.min, rt.min(i))),
                  (a.max = Math.max(a.max, rt.max(i)));
              }),
                (a.min = rt.isFinite(a.min) && !isNaN(a.min) ? a.min : Ci),
                (a.max = rt.isFinite(a.max) && !isNaN(a.max) ? a.max : Pi),
            ...
            _computeTickLimit: function () {
              ...
              return e.isHorizontal()
                ...
                : ((t = rt.options._parseFont(e.options.ticks)),
          ...
          Fi = Si;
        Ii._defaults = Fi;
        var Oi = rt.valueOrDefault,
          Li = rt.math.log10;
        function Ri(t, e) {
          var n,
            i,
            a = [],
            r = Oi(t.min, Math.pow(10, Math.floor(Li(e.min)))),
            o = Math.floor(Li(e.max)),
            l = Math.ceil(e.max / Math.pow(10, o));
          0 === r
            ? ((n = Math.floor(Li(e.minNotZero))),
              (i = Math.floor(e.minNotZero / Math.pow(10, n))),
              a.push(r),
              (r = i * Math.pow(10, n)))
            : ((n = Math.floor(Li(r))), (i = Math.floor(r / Math.pow(10, n))));
          var s = n < 0 ? Math.pow(10, Math.abs(n)) : 1;
          do {
            a.push(r),
              10 === ++i && ((i = 1), (s = ++n >= 0 ? 1 : s)),
              (r = Math.round(i * Math.pow(10, n) * s) / s);
          } while (n < o || (n === o && i < l));
          var u = Oi(t.max, r);
          return a.push(u), a;
        }
        var zi = {
          position: "left",
          ticks: { callback: Zn.formatters.logarithmic },
        };
        function Ni(t, e) {
        ...
        var Bi = mi.extend({
            determineDataLimits: function () {
              ...
              if (void 0 === h)
                for (t = 0; t < u.length; t++)
                  if (
                    ...
                    s.isDatasetVisible(t) && c(e) && void 0 !== e.stack)
                  ) {
                    h = !0;
                    break;
                  }
              if (l.stacked || h) {
                ...
                for (t = 0; t < u.length; t++)
                  if (
                    ((e = s.getDatasetMeta(t)), s.isDatasetVisible(t) && c(e))
                  )
              ...
              (o.min = rt.isFinite(o.min) ? o.min : null),
                (o.max = rt.isFinite(o.max) ? o.max : null),
                (o.minNotZero = rt.isFinite(o.minNotZero)
                  ? o.minNotZero
                  : null),
            ...
            handleTickRangeOptions: function () {
              ...
              (t.min = Ni(e.min, t.min)),
                ...
                t.min === t.max &&
                  (0 !== t.min && null !== t.min
                    ? ((t.min = Math.pow(10, Math.floor(Li(t.min)) - 1)),
                      (t.max = Math.pow(10, Math.floor(Li(t.max)) + 1)))
                    : ((t.min = n), (t.max = i))),
                null === t.min &&
                  (t.min = Math.pow(10, Math.floor(Li(t.max)) - 1)),
                null === t.max &&
                  (t.max =
                    0 !== t.min ? Math.pow(10, Math.floor(Li(t.min)) + 1) : i),
                null === t.minNotZero &&
                  (t.min > 0
                    ? (t.minNotZero = t.min)
                    : t.max < 1
                    ? (t.minNotZero = Math.pow(10, Math.floor(Li(t.max))))
                    : (t.minNotZero = n));
            },
            buildTicks: function () {
              var t = this,
            ...
            convertTicksToLabels: function () {
              (this.tickValues = this.ticks.slice()),
                mi.prototype.convertTicksToLabels.call(this);
            },
            getLabelForIndex: function (t, e) {
              return this._getScaleLabel(this.chart.data.datasets[e].data[t]);
            },
            ...
            _configure: function () {
              ...
              mi.prototype._configure.call(t),
                0 === e &&
                  ...
                  (n =
                    Oi(t.options.ticks.fontSize, $.global.defaultFontSize) /
                    t._length)),
                (t._startValue = Li(e)),
                (t._valueOffset = n),
                (t._valueRange = (Li(t.max) - Li(e)) / (1 - n));
            },
            getPixelForValue: function (t) {
              var e = this,
                n = 0;
              return (
                (t = +e.getRightValue(t)) > e.min &&
                  t > 0 &&
                  (n =
                    (Li(t) - e._startValue) / e._valueRange + e._valueOffset),
          ...
          Ei = zi;
        Bi._defaults = Ei;
        var Wi = rt.valueOrDefault,
          Vi = rt.valueAtIndexOrDefault,
          Hi = rt.options.resolve,
          ji = {
            display: !0,
            animate: !0,
            position: "chartArea",
        ...
        function qi(t) {
          ...
          return e.display && t.display
            ? Wi(e.fontSize, $.global.defaultFontSize) + 2 * e.backdropPaddingY
            : 0;
        }
        function Ui(t, e, n) {
          return rt.isArray(n)
            ? { w: rt.longestText(t, t.font, n), h: n.length * e }
        ...
        function Gi(t) {
          var e,
            n,
            i,
            a = rt.options._parseFont(t.options.pointLabels),
          ...
          for (e = 0; e < l; e++) {
            (i = t.getPointPosition(e, t.drawingArea + 5)),
              (n = Ui(t.ctx, a.lineHeight, t.pointLabels[e])),
              (t._pointLabelSizes[e] = n);
            var s = t.getIndexAngle(e),
              u = rt.toDegrees(s) % 360,
              d = Yi(u, i.x, n.w, 0, 180),
              c = Yi(u, i.y, n.h, 90, 270);
            d.start < r.l && ((r.l = d.start), (o.l = s)),
              d.end > r.r && ((r.r = d.end), (o.r = s)),
              c.start < r.t && ((r.t = c.start), (o.t = s)),
              c.end > r.b && ((r.b = c.end), (o.b = s));
          }
        ...
        function $i(t) {
          ...
          for (var l = t.chart.data.labels.length - 1; l >= 0; l--) {
            var s = 0 === l ? a / 2 : 0,
              ...
              d = Vi(i.fontColor, l, $.global.defaultFontColor);
            e.fillStyle = d;
            var c = t.getIndexAngle(l),
              h = rt.toDegrees(c);
            (e.textAlign = Xi(h)),
              Zi(h, t._pointLabelSizes[l], u),
              Ki(e, t.pointLabels[l], u, o.lineHeight);
          }
          e.restore();
        }
        function Ji(t, e, n, i) {
        ...
        var ta = Mi.extend({
            ...
            _drawGrid: function () {
              var t,
                ...
                o = r.gridLines,
                l = r.angleLines,
                s = Wi(l.lineWidth, o.lineWidth),
                u = Wi(l.color, o.color);
              if (
                (r.pointLabels.display && $i(i),
                o.display &&
                  rt.each(i.ticks, function (t, n) {
                    0 !== n &&
                ...
                for (
                  a.save(),
                    ...
                    a.strokeStyle = u,
                    a.setLineDash &&
                      (a.setLineDash(Hi([l.borderDash, o.borderDash, []])),
                      (a.lineDashOffset = Hi([
                        l.borderDashOffset,
                        o.borderDashOffset,
                        0,
            ...
            _drawLabels: function () {
              ...
              if (n.display) {
                var i,
                  ...
                  l = Wi(n.fontColor, $.global.defaultFontColor);
                e.save(),
                  (e.font = o.string),
          ...
          ea = ji;
        ta._defaults = ea;
        var na = rt._deprecated,
          ia = rt.options.resolve,
          aa = rt.valueOrDefault,
          ...
          for (d.push(n), a = 0, r = d.length; a < r; ++a)
            (s = d[a + 1]),
              ...
              (void 0 !== o && void 0 !== s && Math.round((s + o) / 2) === l) ||
                u.push({ time: l, pos: a / (r - 1) });
          return u;
        }
        function ga(t, e, n) {
          for (var i, a, r, o = 0, l = t.length - 1; o >= 0 && o <= l; ) {
            if (((a = t[(i = (o + l) >> 1) - 1] || null), (r = t[i]), !a))
              return { lo: null, hi: r };
            if (r[e] < n) o = i + 1;
            else {
        ...
        function ma(t, e) {
          ...
          return (
            ...
            null !== o
              ...
              : (a ||
                  "function" !== typeof r ||
                  ((o = r(e)), rt.isFinite(o) || (o = n.parse(o))),
                o)
          );
        }
        function va(t, e) {
        ...
        function ba(t, e, n, i) {
          var a,
            ...
            o,
            l = sa.length;
          for (a = sa.indexOf(t); a < l - 1; ++a)
            if (
              ((o = (r = la[sa[a]]).steps ? r.steps : oa),
        ...
        function xa(t, e, n, i, a) {
          var r, o;
          for (r = sa.length - 1; r >= sa.indexOf(n); r--)
            if (
              ((o = sa[r]), la[o].common && t._adapter.diff(a, i, o) >= e - 1)
            )
              return o;
          return sa[n ? sa.indexOf(n) : 0];
        }
        function ya(t) {
          for (var e = sa.indexOf(t) + 1, n = sa.length; e < n; ++e)
            if (la[sa[e]].common) return sa[e];
        }
        function _a(t, e, n, i) {
          var a,
            r = t._adapter,
            o = t.options,
            l = o.time,
            s = l.unit || ba(l.minUnit, e, n, i),
            u = ia([l.stepSize, l.unitStepSize, 1]),
            d = "week" === s && l.isoWeekday,
            c = e,
            h = [];
          if (
            (d && (c = +r.startOf(c, "isoWeek", d)),
            (c = +r.startOf(c, d ? "day" : s)),
            r.diff(n, e, s) > 1e5 * u)
          )
            throw (
              e +
        ...
        function ka(t, e, n, i, a) {
          ...
          return (
            a.offset &&
              ...
              ((r = pa(t, "time", e[0], "pos")),
              (l =
                1 === e.length ? 1 - r : (pa(t, "time", e[1], "pos") - r) / 2),
              (o = pa(t, "time", e[e.length - 1], "pos")),
              (s =
                1 === e.length
                  ? o
                  : (o - pa(t, "time", e[e.length - 2], "pos")) / 2)),
          ...
          Ca = mi.extend({
            ...
            update: function () {
              var t = this,
                e = t.options,
                n = e.time || (e.time = {}),
                i = (t._adapter = new Kn._date(e.adapters.date));
              return (
                ...
                rt.mergeIf(n.displayFormats, i.formats()),
                mi.prototype.update.apply(t, arguments)
              );
            },
            getRightValue: function (t) {
              return (
            ...
            determineDataLimits: function () {
              var t,
                ...
                m = [],
                v = l._getLabels();
              for (t = 0, n = v.length; t < n; ++t) m.push(va(l, v[t]));
                ...
                if (s.isDatasetVisible(t))
                  if (((a = s.data.datasets[t].data), rt.isObject(a[0])))
                    for (p[t] = [], e = 0, i = a.length; e < i; ++e)
                      (r = va(l, a[e])), g.push(r), (p[t][e] = r);
                  else (p[t] = m.slice(0)), o || ((g = g.concat(m)), (o = !0));
                else p[t] = [];
              m.length &&
                ((h = Math.min(h, m[0])), (f = Math.max(f, m[m.length - 1]))),
                g.length &&
                  ((g = n > 1 ? da(g).sort(ua) : g.sort(ua)),
                  (h = Math.min(h, g[0])),
                  (f = Math.max(f, g[g.length - 1]))),
                (h = va(l, ca(d)) || h),
                (f = va(l, ha(d)) || f),
                (h = h === oa ? +u.startOf(Date.now(), c) : h),
                (f = f === ra ? +u.endOf(Date.now(), c) + 1 : f),
                (l.min = Math.min(h, f)),
            ...
            buildTicks: function () {
              ...
              return (
                ...
                (i._unit =
                  s.unit ||
                  (l.autoSkip
                    ? ba(s.minUnit, i.min, i.max, c)
                    : xa(i, d.length, s.minUnit, i.min, i.max))),
                (i._majorUnit =
                  l.major.enabled && "year" !== i._unit ? ya(i._unit) : void 0),
                (i._table = fa(i._timestamps.data, a, r, f)),
                (i._offsets = ka(i._table, d, a, r, o)),
                l.reverse && d.reverse(),
                Ma(i, d, i._majorUnit)
              );
            },
            getLabelForIndex: function (t, e) {
              ...
              return (
                rt.isObject(l) && (o = n.getRightValue(l)),
                r.tooltipFormat
                  ? i.format(ma(n, o), r.tooltipFormat)
                  : "string" === typeof o
                  ? o
                  : i.format(ma(n, o), r.displayFormats.datetime)
              );
            },
            ...
            _getLabelSize: function (t) {
              var e = this,
                ...
                r = Math.cos(a),
                o = Math.sin(a),
                l = aa(n.fontSize, $.global.defaultFontSize);
            ...
            getLabelCapacity: function (t) {
              var e = this,
                ...
                r = e.tickFormatFunction(t, 0, Ma(e, [t], e._majorUnit), a),
                o = e._getLabelSize(r),
                l = Math.floor(
        ...
        Kn._date.override(
          ...
          $._set("global", { plugins: { filler: { propagate: !0 } } });
        var Ta = {
          dataset: function (t) {
            var e = t.fill,
              n = t.chart,
        ...
        function La(t) {
          return (t.el._scale || {}).getPointPositionForValue ? Oa(t) : Fa(t);
        }
        function Ra(t, e, n) {
          var i,
            a = t[e].fill,
        ...
        function za(t) {
          var e = t.fill,
            n = "dataset";
          return !1 === e ? null : (isFinite(e) || (n = "boundary"), Ta[n](t));
        }
        function Na(t) {
          return t && !t.skip;
        }
        function Ba(t, e, n, i, a) {
          ...
          if (i && a) {
            for (t.moveTo(e[0].x, e[0].y), r = 1; r < i; ++r)
              rt.canvas.lineTo(t, e[r - 1], e[r]);
            if (void 0 === n[0].angle)
              for (t.lineTo(n[a - 1].x, n[a - 1].y), r = a - 1; r > 0; --r)
                rt.canvas.lineTo(t, n[r], n[r - 1], !0);
            else
              for (
                o = n[0].cx,
                  l = n[0].cy,
                ...
                t.arc(o, l, s, n[r].angle, n[r - 1].angle, !0);
          }
        }
        function Ea(t, e, n, i, a, r) {
          ...
          for (t.beginPath(), o = 0, l = g; o < l; ++o)
            (d = n((u = e[(s = o % g)]._view), s, i)),
              (c = Na(u)),
              (h = Na(d)),
              r && void 0 === f && c && (l = g + (f = o + 1)),
              c && h
                ? ((b = m.push(u)), (x = v.push(d)))
                : b &&
                  x &&
                  (p
                    ? (c && m.push(u), h && v.push(d))
                    : (Ba(t, m, v, b, x), (b = x = 0), (m = []), (v = [])));
          Ba(t, m, v, b, x), t.closePath(), (t.fillStyle = a), t.fill();
        }
        var Wa = {
            id: "filler",
            ...
            beforeDatasetsDraw: function (t) {
              ...
              for (n = s.length - 1; n >= 0; --n)
                (e = s[n].$filler) &&
                  ...
                  (r = i._children || []),
                  (o = e.mapper),
                  (l = a.backgroundColor || $.global.defaultColor),
                  o &&
                    l &&
                    r.length &&
                    (rt.canvas.clipArea(u, t.chartArea),
                    Ea(u, r, o, a, l, i._loop),
                    rt.canvas.unclipArea(u)));
            },
          },
          Va = rt.rtl.getRtlAdapter,
          Ha = rt.noop,
          ja = rt.valueOrDefault;
        function qa(t, e) {
        ...
        var Ua = ft.extend({
          ...
          fit: function () {
            ...
            if (
              (u
                ? ((s.width = t.maxWidth), (s.height = i ? 10 : 0))
                : ((s.width = i ? 10 : 0), (s.height = t.maxHeight)),
              i)
            ) {
              if (((a.font = r.string), u)) {
                ...
                (a.textAlign = "left"),
                  ...
                  rt.each(t.legendItems, function (t, e) {
                    var i = qa(n, o) + o / 2 + a.measureText(t.text).width;
                    (0 === e ||
                      d[d.length - 1] + i + 2 * n.padding > s.width) &&
                      ((c += o + n.padding),
                      (d[d.length - (e > 0 ? 0 : 1)] = 0)),
                      (l[e] = { left: 0, top: 0, width: i, height: o }),
          ...
          draw: function () {
            ...
            if (e.display) {
              var d,
                c = Va(e.rtl, t.left, t.minSize.width),
                h = t.ctx,
                f = ja(n.fontColor, i.defaultFontColor),
              ...
              var m = qa(n, p),
                ...
                b = function (t, e, i) {
                  if (!(isNaN(m) || m <= 0)) {
                    h.save();
                    var o = ja(i.lineWidth, r.borderWidth);
                    if (
                      ((h.fillStyle = ja(i.fillStyle, a)),
                      (h.lineCap = ja(i.lineCap, r.borderCapStyle)),
                      (h.lineDashOffset = ja(
                        i.lineDashOffset,
                        r.borderDashOffset
                      )),
                      (h.lineJoin = ja(i.lineJoin, r.borderJoinStyle)),
                      (h.lineWidth = o),
                      (h.strokeStyle = ja(i.strokeStyle, a)),
                      h.setLineDash &&
                        h.setLineDash(ja(i.lineDash, r.borderDash)),
                      n && n.usePointStyle)
                    ) {
                ...
                x = function (t, e, n, i) {
                  var a = p / 2,
                    r = c.xPlus(t, m + a),
                    o = e + a;
                  h.fillText(n.text, r, o),
                    n.hidden &&
                      (h.beginPath(),
                      (h.lineWidth = 2),
                      h.moveTo(r, o),
                      h.lineTo(c.xPlus(r, i), o),
                      h.stroke());
                },
                y = function (t, i) {
                  switch (e.align) {
                ...
                _ = t.isHorizontal();
              (d = _
                ? { x: t.left + y(s, u[0]), y: t.top + n.padding, line: 0 }
                : { x: t.left + n.padding, y: t.top + y(o, l[0]), line: 0 }),
              ...
              rt.each(t.legendItems, function (e, i) {
                ...
                c.setWidth(t.minSize.width),
                  _
                    ? i > 0 &&
                      f + r + n.padding > t.left + t.minSize.width &&
                      ((g = d.y += k),
                      d.line++,
                      (f = d.x = t.left + y(s, u[d.line])))
                    : i > 0 &&
                      g + k > t.top + t.minSize.height &&
                      ((f = d.x = f + t.columnWidths[d.line] + n.padding),
                      d.line++,
                      (g = d.y = t.top + y(o, l[d.line])));
                var w = c.x(f);
                b(w, g, e),
                  (v[i].left = c.leftForLtr(w, v[i].width)),
                  (v[i].top = g),
                  x(w, g, e, a),
                  _ ? (d.x += r + n.padding) : (d.y += k);
              }),
        ...
        function Ya(t, e) {
          var n = new Ua({ ctx: t.ctx, options: e, chart: t });
        ...
        var Ga = {
            ...
            beforeUpdate: function (t) {
              var e = t.options.legend,
                n = t.legend;
              e
                ? (rt.mergeIf(e, $.global.legend),
                  n ? (je.configure(t, n, e), (n.options = e)) : Ya(t, e))
                : n && (je.removeBox(t, n), delete t.legend);
            },
        ...
        var Ka = ft.extend({
          ...
          fit: function () {
            ...
            n.display
              ? ((t =
                  (rt.isArray(n.text) ? n.text.length : 1) *
                    rt.options._parseFont(n).lineHeight +
                  2 * n.padding),
          ...
          draw: function () {
            ...
            if (n.display) {
              var i,
                ...
                h = t.bottom,
                f = t.right;
              (e.fillStyle = rt.valueOrDefault(
                n.fontColor,
                $.global.defaultFontColor
              )),
                (e.font = o.string),
                t.isHorizontal()
                  ? ((a = c + (f - c) / 2), (r = d + s), (i = f - c))
                  : ((a = "left" === n.position ? c + s : f - s),
                    (r = d + (h - d) / 2),
                    (i = h - d),
        ...
        function Za(t, e) {
          var n = new Ka({ ctx: t.ctx, options: e, chart: t });
          ...
          tr = {
            ...
            beforeUpdate: function (t) {
              var e = t.options.title,
                n = t.titleBlock;
              e
                ? (rt.mergeIf(e, $.global.title),
                  n ? (je.configure(t, n, e), (n.options = e)) : Za(t, e))
                : n && (je.removeBox(t, n), delete t.titleBlock);
            },
          };
        for (var er in (($a.filler = Ja),
        ($a.legend = Qa),
        ($a.title = tr),
        (Un.helpers = rt),
        Yn(),
