  ...
  [10],
  {
    ...
    iEK7: function (e, a, r) {
      ...
      var d = i,
        ...
        f = o.a.createElement;
      function c(e) {
        let { repo: a, theme: r } = e;
        return f(
          "div",
          {
            className: "repo-card-div",
            style: { backgroundColor: r.highlight },
          },
          f(
            m.Fade,
            ...
            f(
              "div",
              {
                key: a.id,
                onClick: () => {
                  return (e = a.url), void window.open(e, "_blank").focus();
                  var e;
                },
              },
              f(
                ...
                f(
                  "p",
                  { className: "repo-name", style: { color: r.text } },
                  a.name
                )
              ),
              f(
                "p",
                { className: "repo-description", style: { color: r.text } },
                a.description
              ),
              f(
                "div",
                ...
                f(d, { className: "repo-languages", logos: a.languages })
              )
            )
          )
        );
        ...
        render() {
          ...
          return w(
            ...
            w(
              ...
              g.data.map((a) => w(c, { repo: a, theme: e }))
            ),
            w(h.a, {
              text: "More Projects",
              className: "project-button",
              href: p.f.githubProfile,
              newTab: !0,
              theme: e,
            }),
            w(u.a, { theme: this.props.theme })
          );
        }
      }
      a.default = y;
