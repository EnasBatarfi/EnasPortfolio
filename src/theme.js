...
export const babyPinkTheme = {
  body: "#FFEFF7", // Soft baby pink background
  text: "#A64D79", // Muted pinkish-purple text
  expTxtColor: "#000a12",
  highlight: "#FFD6E0", // Light pastel pink highlights
  dark: "#733A5D", // Deeper pink accent
  secondaryText: "#D892A8", // Soft rosy pink
  imageHighlight: "#FFB6C1", // Classic baby pink
  compImgHighlight: "#FDE7EC", // Very light pink for contrast
  jacketColor: "#F4A7B9", // Gentle pinkish-red
  headerColor: "#FFB6C177", // Transparent baby pink
  splashBg: "#A64D79", // Deeper pastel pink for contrast
};
